...
type flavor interface {
	...
	// restartSubordinate returns the commands to stop, reset and start the subordinate.
	restartSubordinateCommands() []string
...
// RestartSubordinateCommands returns the commands to stop, reset and start the subordinate.
func (c *Conn) RestartSubordinateCommands() []string {
	return c.flavor.restartSubordinateCommands()
}
