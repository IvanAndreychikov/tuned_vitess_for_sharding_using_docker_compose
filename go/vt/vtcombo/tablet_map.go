...
func (itmc *internalTabletManagerClient) SetMain(ctx context.Context, tablet *topodatapb.Tablet, parent *topodatapb.TabletAlias, timeCreatedNS int64, waitPosition string, forceStartSubordinate bool) error {
	return fmt.Errorf("not implemented in vtcombo")
}
