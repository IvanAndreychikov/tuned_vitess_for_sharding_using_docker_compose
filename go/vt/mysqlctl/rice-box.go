...
func init() {
	...
	filed := &embedded.EmbeddedFile{
		Filename:    "mycnf/main_mysql57.cnf",
		FileModTime: time.Unix(1579019403, 0),
	...
	dir4 := &embedded.EmbeddedDir{
		...
		ChildFiles: []*embedded.EmbeddedFile{
			...
			file7, // "mycnf/main_mariadb100.cnf"
			file8, // "mycnf/main_mariadb101.cnf"
			file9, // "mycnf/main_mariadb102.cnf"
			filea, // "mycnf/main_mariadb103.cnf"
			fileb, // "mycnf/main_mariadb104.cnf"
			filec, // "mycnf/main_mysql56.cnf"
			filed, // "mycnf/main_mysql57.cnf"
			filee, // "mycnf/main_mysql80.cnf"
			filef, // "mycnf/sbr.cnf"
	...
	embedded.RegisterEmbeddedBox(`../../../config`, &embedded.EmbeddedBox{
		...
		Files: map[string]*embedded.EmbeddedFile{
			...
			"mycnf/main_mariadb100.cnf": file7,
			"mycnf/main_mariadb101.cnf": file8,
			"mycnf/main_mariadb102.cnf": file9,
			"mycnf/main_mariadb103.cnf": filea,
			"mycnf/main_mariadb104.cnf": fileb,
			"mycnf/main_mysql56.cnf":    filec,
			"mycnf/main_mysql57.cnf":    filed,
			"mycnf/main_mysql80.cnf":    filee,
			"mycnf/sbr.cnf":               filef,
