...
func TestSuite(t *testing.T, ts *topo.Server, client vtctlclient.VtctlClient) {
	...
	tablet := &topodatapb.Tablet{
		...
		MainTermStartTime: logutil.TimeToProto(time.Date(1970, 1, 1, 1, 1, 1, 1, time.UTC)),
	...
	expected := "cell1-0000000001 test_keyspace <null> main localhost:3333 localhost:3334 [tag: \"value\"] 1970-01-01T01:01:01Z\n"
