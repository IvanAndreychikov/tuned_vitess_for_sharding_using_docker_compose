...
func TestMigrateServedTypes(t *testing.T) {
	...
	dest1Main.Agent.VREngine = vreplication.NewTestEngine(ts, "", dest1Main.FakeMysqlDaemon, dbClientFactory1, dbClient1.DBName(), nil)
	...
	dest2Main.Agent.VREngine = vreplication.NewTestEngine(ts, "", dest2Main.FakeMysqlDaemon, dbClientFactory2, dbClient2.DBName(), nil)
	// select * from _vt.vreplication during Open
...
func TestMultiShardMigrateServedTypes(t *testing.T) {
	...
	dbClient1 := binlogplayer.NewMockDBClient(t)
	dbClientFactory1 := func() binlogplayer.DBClient { return dbClient1 }
	dest1Main.Agent.VREngine = vreplication.NewTestEngine(ts, "", dest1Main.FakeMysqlDaemon, dbClientFactory1, "db", nil)
	// select * from _vt.vreplication during Open
	dbClient1.ExpectRequest("select * from _vt.vreplication where db_name='db'", &sqltypes.Result{}, nil)
	if err := dest1Main.Agent.VREngine.Open(context.Background()); err != nil {
		t.Fatal(err)
	...
	dbClient2 := binlogplayer.NewMockDBClient(t)
	dbClientFactory2 := func() binlogplayer.DBClient { return dbClient2 }
	dest2Main.Agent.VREngine = vreplication.NewTestEngine(ts, "", dest2Main.FakeMysqlDaemon, dbClientFactory2, "db", nil)
	// select * from _vt.vreplication during Open
	dbClient2.ExpectRequest("select * from _vt.vreplication where db_name='db'", &sqltypes.Result{}, nil)
	if err := dest2Main.Agent.VREngine.Open(context.Background()); err != nil {
		t.Fatal(err)
	...
	dbClient1 = binlogplayer.NewMockDBClient(t)
	dbClientFactory1 = func() binlogplayer.DBClient { return dbClient1 }
	dest3Main.Agent.VREngine = vreplication.NewTestEngine(ts, "", dest3Main.FakeMysqlDaemon, dbClientFactory1, "db", nil)
	// select * from _vt.vreplication during Open
	dbClient1.ExpectRequest("select * from _vt.vreplication where db_name='db'", &sqltypes.Result{}, nil)
	...
	dbClient2 = binlogplayer.NewMockDBClient(t)
	dbClientFactory2 = func() binlogplayer.DBClient { return dbClient2 }
	dest4Main.Agent.VREngine = vreplication.NewTestEngine(ts, "", dest4Main.FakeMysqlDaemon, dbClientFactory2, "db", nil)
	// select * from _vt.vreplication during Open
	dbClient2.ExpectRequest("select * from _vt.vreplication where db_name='db'", &sqltypes.Result{}, nil)
