...
func (wr *Wrangler) CopySchemaShardFromShard(ctx context.Context, tables, excludeTables []string, includeViews bool, sourceKeyspace, sourceShard, destKeyspace, destShard string, waitSubordinateTimeout time.Duration, skipVerify bool) error {
	...
	return wr.CopySchemaShard(ctx, sourceShardInfo.MainAlias, tables, excludeTables, includeViews, destKeyspace, destShard, waitSubordinateTimeout, skipVerify)
}
...
// binlogs.
func (wr *Wrangler) CopySchemaShard(ctx context.Context, sourceTabletAlias *topodatapb.TabletAlias, tables, excludeTables []string, includeViews bool, destKeyspace, destShard string, waitSubordinateTimeout time.Duration, skipVerify bool) error {
