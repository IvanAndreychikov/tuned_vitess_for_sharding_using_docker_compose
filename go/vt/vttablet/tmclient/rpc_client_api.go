...
type TabletManagerClient interface {
	...
	SetMain(ctx context.Context, tablet *topodatapb.Tablet, parent *topodatapb.TabletAlias, timeCreatedNS int64, waitPosition string, forceStartSubordinate bool) error
	...
	// PromoteReplica makes the tablet the new main
