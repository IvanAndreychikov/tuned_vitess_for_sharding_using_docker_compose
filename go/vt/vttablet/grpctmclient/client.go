...
func (client *Client) SetMain(ctx context.Context, tablet *topodatapb.Tablet, parent *topodatapb.TabletAlias, timeCreatedNS int64, waitPosition string, forceStartSubordinate bool) error {
	cc, c, err := client.dial(tablet)
	if err != nil {
		return err
	}
