...
func verifyVtgateVariables(t *testing.T, url string) {
	...
	if resp != nil && resp.StatusCode == 200 {
		...
		if !isMainTabletPresent(healthCheckConnection) {
			t.Error("Atleast one main tablet needs to be present")
		}
	} else {
...
func isMainTabletPresent(tablets map[string]interface{}) bool {
